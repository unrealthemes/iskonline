    ...
    renderStep() {
        ...
        <div class="bg-white block">
            ...
            <div class="mt-3 d-flex align-items-center gap-2">
                ${this.step > 0 ? `<span data-prev-step role="button" class="badge bg-primary"><i class="fa-solid fa-left-long"></i></span>` : ``}
                <span class="badge bg-primary">${this.step + 1} / ${this.json.steps.length}</span> 
                <h3>${this.json.steps[this.step].title}</h3>
            </div>
            <ul class="row py-3 mb-0">
                
            </ul>
            <button data-next-step class="btn btn-primary mt-3">Далее</button>
        </div>
        `;
