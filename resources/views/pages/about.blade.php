...
<section class="about">
    <div class="container">
      ...
      <div class="about__content shadow-top shadow-bottom row">
        ...
        <div class="about__bottom col-lg-3 col-md-4 col-12 offset-lg-1 d-md-block d-none">
