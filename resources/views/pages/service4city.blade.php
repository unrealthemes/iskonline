...
@section('meta')
 <meta name="keywords" content="подсудность, территориальная подсудность, подсудность онлайн, подсудность по адресу, мировой суд по адресу">
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-7">
                ...
                {{-- <h1>{{ $service->h1 }}</h1> --}}
                <p class='hero-text'>{{ $seo['description'] }}</p>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        ...
        {{-- <div class=""> --}}
            <div class="row">
				...
				//echo $seo['text'];
				$text=str_replace('h3','h2',$text);
				
				$text=str_replace('</ul><h2>','</ul><p></p><h2>',$text);
				
				$data=str_replace('</p><h2>','</p></div></div><div class="about-list__row shadow-top row"><div class="col-lg-4"><h3>',$text);
				$data=str_replace('<h2>','<div class="about-list__row shadow-top row"><div class="col-lg-4"><h3>',$data);
				$data=str_replace('</h2>','</h3>
                        </div>
